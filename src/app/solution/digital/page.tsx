...
export default function DigitalTwinPage() {
  const { t } = useLanguage();
  const content = t.solution.digitalTwin;
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed mb-4">{content.text1}</p>
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed mb-4">{content.text3}</p>
              <p className="text-gray-400 leading-relaxed">{content.text4}</p>
            </motion.div>
          </div>
