...
export default function ParvisAgentPage() {
  const { t } = useLanguage();
  const content = t.solution.parvisAgent;
    ...
    <div className="pt-20 bg-background min-h-screen">
      ...
      <section className="py-24 relative">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-400 text-sm">Automatic requirement extraction</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">Full traceability management</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">Multi-format analysis</span>
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-gray-400 text-sm">MISRA-compliant refactoring</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">Magic number handling</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">Auto Doxygen docs</span>
                </li>
              </ul>
            </motion.div>
            ...
            >
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">Quality verification</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">V-Model evaluation</span>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" />
                  <span className="text-gray-400 text-sm">HTML report generation</span>
                </li>
              </ul>
            </motion.div>
          </div>
          ...
          >
            <h3 className="text-2xl font-bold text-white mb-8 text-center">Benefits</h3>
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Traceability</h4>
                  <p className="text-gray-400 text-sm">End-to-end tracking</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">MISRA Compliance</h4>
                  <p className="text-gray-400 text-sm">Automatic standards</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-cyan-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">70%+ Time Saved</h4>
                  <p className="text-gray-400 text-sm">Faster verification</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <div className="w-10 h-10 bg-blue-500/20 rounded-lg flex items-center justify-center flex-shrink-0">
                ...
                <div>
                  <h4 className="text-white font-semibold mb-1">Quality Loop</h4>
                  <p className="text-gray-400 text-sm">AI-based management</p>
                </div>
              </div>
            </div>
          </motion.div>
