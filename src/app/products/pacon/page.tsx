...
export default function PaconPage() {
  ...
  const features = [
    { icon: Code2, title: content.feature1Title, desc: content.feature1Desc, color: "amber" },
    { icon: Bug, title: content.feature2Title, desc: content.feature2Desc, color: "orange" },
    { icon: Terminal, title: content.feature3Title, desc: content.feature3Desc, color: "yellow" },
    { icon: FileCode, title: content.feature4Title, desc: content.feature4Desc, color: "amber" },
    { icon: Network, title: content.feature5Title, desc: content.feature5Desc, color: "orange" },
    { icon: Container, title: content.feature6Title, desc: content.feature6Desc, color: "yellow" },
  ];
  ...
  return (
    <div className="pt-20 bg-background min-h-screen overflow-hidden">
      ...
      <section className="relative min-h-[90vh] flex items-center">
        {/* Background Effects - Amber theme */}
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 -left-32 w-[500px] h-[500px] bg-amber-500/20 rounded-full blur-[120px]" />
          <div className="absolute bottom-1/4 -right-32 w-[600px] h-[600px] bg-orange-500/15 rounded-full blur-[150px]" />
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
                ...
                <span className="text-sm text-amber-400 font-medium">{content.badge}</span>
              </div>
              ...
              <p className="text-xl lg:text-2xl text-text-secondary mb-4 leading-relaxed">
                ...
                <br />
                <span className="text-amber-400">{content.heroSubtitle2}</span>
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/support/qna"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold rounded-xl hover:from-amber-400 hover:to-orange-400 transition-all hover:shadow-lg hover:shadow-amber-500/25"
                >
                ...
                <Link
                  href="#features"
                  className="inline-flex items-center justify-center gap-2 px-8 py-4 bg-surface border border-border text-white font-semibold rounded-xl hover:bg-surface-elevated hover:border-amber-500/30 transition-all"
                >
                  {content.learnMore}
                </Link>
              </div>
            ...
            >
              <div className="relative w-full max-w-lg mx-auto">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-64 h-64 bg-gradient-to-br from-amber-500/30 to-orange-500/20 rounded-full blur-[80px] animate-pulse" />
                </div>

                {/* IDE Window */}
                <div className="relative bg-[#1e1e1e] backdrop-blur-xl border border-amber-500/20 rounded-2xl overflow-hidden shadow-2xl">
                  {/* IDE Header */}
                  ...
                  <div className="p-4 font-mono text-sm min-h-[280px]">
                    {codeLines.map((line, index) => (
                      ...
                      >
                        ...
                        <span className={`
                          ...
                          ${line.type === 'function' ? 'text-amber-400' : ''}
                          ${line.type === 'typing' ? 'text-white' : ''}
                        `}>
                          {line.code}
                          {line.cursor && <span className="animate-pulse text-amber-400">|</span>}
                        </span>
                      </motion.div>
                    ))}
                    ...
                    <motion.div
                      ...
                      className="ml-12 mt-1 bg-[#252526] border border-amber-500/30 rounded-lg overflow-hidden shadow-xl w-52"
                    >
                      {autocompleteSuggestions.map((suggestion, index) => (
                        <div
                          key={suggestion}
                          className={`px-3 py-1.5 text-xs flex items-center gap-2 ${
                            index === 0 ? 'bg-amber-500/20 text-amber-400' : 'text-text-secondary hover:bg-surface'
                          }`}
                        >
                ...
                <motion.div
                  ...
                  transition={{ delay: 2 }}
                  className="absolute -left-4 top-1/4 bg-surface border border-amber-500/20 rounded-xl px-3 py-2 shadow-lg"
                >
                  <div className="flex items-center gap-2">
                ...
                <motion.div
                  ...
                  className="absolute -right-4 bottom-1/3 bg-surface border border-orange-500/20 rounded-xl px-3 py-2 shadow-lg"
                >
                  <div className="flex items-center gap-2">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {features.map((feature, index) => {
              const colorClasses: Record<string, { border: string; bg: string }> = {
                amber: { border: "border-amber-500/20 hover:border-amber-500/40", bg: "from-amber-500 to-amber-600" },
                orange: { border: "border-orange-500/20 hover:border-orange-500/40", bg: "from-orange-500 to-orange-600" },
                yellow: { border: "border-yellow-500/20 hover:border-yellow-500/40", bg: "from-yellow-500 to-yellow-600" },
              };
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div>
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 mb-6">
                  <Container className="w-4 h-4 text-orange-400" />
                  <span className="text-sm text-orange-400 font-medium">{content.virtualEcuBadge}</span>
                </div>
                ...
                <div className="space-y-4">
                  {content.virtualEcuItems.map((item: string, index: number) => (
                    <motion.div
                      key={index}
              ...
              <motion.div
                ...
                className="relative"
              >
                <div className="absolute inset-0 bg-gradient-to-br from-orange-500/10 to-amber-500/10 rounded-3xl blur-xl" />
                <div className="relative bg-surface border border-orange-500/20 rounded-2xl p-6 shadow-2xl">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                <div className="absolute inset-0 bg-gradient-to-br from-amber-500/10 to-yellow-500/10 rounded-3xl blur-xl" />
                <div className="relative bg-surface border border-amber-500/20 rounded-2xl p-6 shadow-2xl">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    {['Build', 'Test', 'Deploy to Virtual ECU', 'Integration Test'].map((step, index) => (
                      ...
                      >
                        <div className={`w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium ${
                          index < 3 ? 'bg-emerald-500/20 text-emerald-400' : 'bg-amber-500/20 text-amber-400'
                        }`}>
                        ...
                        {index === 3 && (
                          <div className="text-amber-400 text-xs animate-pulse">Running...</div>
                        )}
                      </motion.div>
                    ))}
                  </div>
              ...
              <div className="order-1 lg:order-2">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
                  ...
                  <span className="text-sm text-amber-400 font-medium">{content.jenkinsBadge}</span>
                </div>
                <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
                ...
                <div className="space-y-4">
                  {content.jenkinsItems.map((item: string, index: number) => (
                    <motion.div
                      key={index}
                      initial={{ opacity: 0, x: -20 }}
                      whileInView={{ opacity: 1, x: 0 }}
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {benefits.map((benefit, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: index * 0.1 }}
                className="group bg-surface border border-border rounded-2xl p-6 hover:border-amber-500/30 hover:shadow-lg hover:shadow-amber-500/5 transition-all duration-300"
              >
                <div className="w-12 h-12 bg-gradient-to-br from-amber-500/20 to-orange-500/20 rounded-xl flex items-center justify-center mb-4 group-hover:from-amber-500/30 group-hover:to-orange-500/30 transition-colors">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-amber-500/10 border border-amber-500/20 mb-6">
              ...
              <span className="text-sm text-amber-400 font-medium">{content.demoBadge}</span>
            </div>
      ...
      <section className="py-24 relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <Link
              href="/support/qna"
              className="inline-flex items-center gap-2 px-10 py-5 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-semibold rounded-xl hover:from-amber-400 hover:to-orange-400 transition-all hover:shadow-xl hover:shadow-amber-500/25 text-lg"
            >
              <span>{content.contact}</span>
