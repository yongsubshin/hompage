...
export default function AdaptivePage() {
  ...
  const tools = [
    {
      icon: FileCode,
      title: content.toolAuthoring,
      name: content.toolAuthoringName,
    ...
    {
      icon: Cpu,
      title: content.toolFunctional,
      name: content.toolFunctionalName,
      href: "/products/para",
    ...
    {
      icon: Code2,
      title: content.toolIde,
      name: content.toolIdeName,
      href: "/products/pacon",
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <p className="text-text-secondary text-lg max-w-2xl mx-auto">
              Design, Build, and Test your Adaptive Applications
            </p>
          </motion.div>
              ...
              <div className="grid md:grid-cols-3 gap-8">
                ...
                >
                  <div className="bg-surface border border-accent-cyan/30 rounded-2xl p-6 text-center relative z-10">
                    ...
                    <p className="text-text-tertiary text-sm">Create ARXML models with AutoSAR.io</p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="bg-surface border border-accent-blue/30 rounded-2xl p-6 text-center relative z-10">
                    ...
                    <p className="text-text-tertiary text-sm">Build with PARA platform APIs</p>
                  </div>
                </motion.div>
                ...
                >
                  <div className="bg-surface border border-violet-500/30 rounded-2xl p-6 text-center relative z-10">
                    ...
                    <h3 className="text-white font-semibold mb-2">Develop & Test</h3>
                    <p className="text-text-tertiary text-sm">Code and debug in PACON IDE</p>
                  </div>
                </motion.div>
              </div>
            </div>
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 border border-white/20 rounded-full mb-6">
              ...
              <span className="text-sm text-white font-medium">Start Building Today</span>
            </div>
            <h2 className="text-3xl lg:text-4xl font-bold text-white mb-4">
              {content.subtitle}
            </h2>
            <p className="text-text-secondary text-lg mb-8">
              Experience the complete Adaptive AUTOSAR development workflow
            </p>
