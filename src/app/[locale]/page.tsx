...
export default function Home() {
  ...
  const products = [
    {
      icon: Cpu,
      title: t("autosarTitle"),
      subtitle: t("autosarSubtitle"),
      description: t("autosarDesc"),
      href: "/products",
    },
    {
      icon: Layers,
      title: t("paraTitle"),
      subtitle: t("paraSubtitle"),
      description: t("paraDesc"),
      href: "/products/para",
    },
    {
      icon: Code2,
      title: t("paconTitle"),
      subtitle: t("paconSubtitle"),
      description: t("paconDesc"),
      href: "/products/pacon",
    },
  ];
  ...
  const aiProducts = [
    {
      icon: Brain,
      title: t("parvisTitle"),
      subtitle: t("parvisSubtitle"),
      description: t("parvisDesc"),
      href: "/products/ai",
    },
    {
      icon: Sparkles,
      title: t("parvisAdkTitle"),
      subtitle: t("parvisAdkSubtitle"),
      description: t("parvisAdkDesc"),
      href: "/products/parvisadk",
    },
    {
      icon: Bot,
      title: t("aiAgentTitle"),
      subtitle: t("aiAgentSubtitle"),
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container-custom text-center py-32 pb-40">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-white tracking-tight leading-normal">
              ...
              <span className="text-accent-blue">
                <SplitText delay={0.5} direction="up">
                  {t("heroTitle").split(" ").slice(2).join(" ") || "mobility"}
                </SplitText>
              </span>
            </h1>
          </div>
          ...
          <motion.p
            ...
            className="text-lg sm:text-xl text-text-secondary px-4 sm:px-8 lg:px-16 mx-auto mb-12 text-balance"
          >
            {t("heroDesc")}
          </motion.p>
          ...
          >
            <Link href="/products">
              <RippleButton className="btn-primary group inline-flex items-center gap-2">
                <span>{common("exploreProducts")}</span>
          ...
          >
            ...
            >
              <span className="text-xs uppercase tracking-wider">{common("scroll")}</span>
