...
export default function AiTrainingPage() {
  ...
  const trainingPillars = [
    {
      icon: Brain,
      title: t("aiPage.designTitle"),
      desc: t("aiPage.designDesc"),
      color: "cyan",
    },
    {
      icon: Code,
      title: t("aiPage.practiceTitle"),
      desc: t("aiPage.practiceDesc"),
      color: "blue",
    },
    {
      icon: Layers,
      title: t("aiPage.standardsTitle"),
      desc: t("aiPage.standardsDesc"),
      color: "emerald",
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-6">
                ...
                <span className="text-cyan-400 text-sm font-medium">{t("aiPage.badge")}</span>
              </div>
            ...
            <div className="relative h-[400px] hidden lg:block">
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-white font-semibold mb-1">{t("aiPage.card1Title")}</h3>
                  <p className="text-gray-400 text-sm">{t("aiPage.card1Desc")}</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-white font-semibold mb-1">{t("aiPage.card2Title")}</h3>
                  <p className="text-gray-400 text-sm">{t("aiPage.card2Desc")}</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-white font-semibold mb-1">{t("aiPage.card3Title")}</h3>
                  <p className="text-gray-400 text-sm">{t("aiPage.card3Desc")}</p>
                </motion.div>
              </motion.div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              {t("aiPage.pillarsTitle")}
            </h2>
            <p className="text-gray-400 max-w-2xl mx-auto">
              {t("aiPage.pillarsSubtitle")}
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="space-y-4">
              {t.raw("aiTraining.scopeList").map((item: string, index: number) => (
                <motion.div
                  key={index}
