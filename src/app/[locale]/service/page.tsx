...
export default function ServicePage() {
  ...
  const services = [
    ...
    {
      id: "autosar",
      name: nav("serviceAutosar"),
      description: t("cards.autosar"),
      icon: Settings,
      color: "blue",
    ...
    {
      id: "education",
      name: nav("serviceTraining"),
      description: t("cards.education"),
      icon: GraduationCap,
      color: "cyan",
    ...
    {
      id: "tool",
      name: nav("serviceCustom"),
      description: t("cards.tool"),
      icon: Wrench,
      color: "blue",
      href: "/service/tool",
    },
    {
      id: "ai",
      name: nav("serviceAiTraining"),
      description: t("cards.ai"),
      icon: Bot,
      color: "cyan",
      href: "/service/ai",
    },
      ...
      <section className="section-padding bg-background relative overflow-hidden">
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              {t("mainTitle").split(" ")[0]}{" "}
              <span className="gradient-text">{t("mainTitle").split(" ").slice(1).join(" ")}</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
