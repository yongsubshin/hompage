          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20 mb-6">
                ...
                <span className="text-cyan-400 text-sm font-medium">{t("toolPage.badge")}</span>
              </div>
            ...
            <div className="relative h-[400px] hidden lg:block">
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-white font-semibold mb-1">{t("toolPage.card1Title")}</h3>
                  <p className="text-gray-400 text-sm">{t("toolPage.card1Desc")}</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-white font-semibold mb-1">{t("toolPage.card2Title")}</h3>
                  <p className="text-gray-400 text-sm">{t("toolPage.card2Desc")}</p>
                </motion.div>
              </motion.div>
              ...
              >
                ...
                >
                  ...
                  <h3 className="text-white font-semibold mb-1">{t("toolPage.card3Title")}</h3>
                  <p className="text-gray-400 text-sm">{t("toolPage.card3Desc")}</p>
                </motion.div>
              </motion.div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-gray-400 max-w-2xl mx-auto">
              {t("toolPage.examplesSubtitle")}
            </p>
          </motion.div>

          {/* Tool Grid */}
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {t.raw("tool.exampleList").map((title: string, index: number) => {
              ...
              return (
                ...
                >
                  <div className={`h-full bg-[#12121a] border border-${color}-500/20 rounded-2xl p-6 hover:border-${color}-500/40 transition-all duration-300 group`}>
                    ...
                    <p className="text-gray-400 text-sm">{t("tool.exampleDescList")[index]}</p>
                  </div>
                </motion.div>
              );
            })}
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">
              {t("toolPage.ctaTitle1")}{" "}
              <br />
              <span className="bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                {t("toolPage.ctaTitle2")}
              </span>
            </h2>
