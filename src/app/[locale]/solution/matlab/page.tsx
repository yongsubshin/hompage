        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">{t("matlab.text1")}</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-400 leading-relaxed">{t("matlab.text2")}</p>
            </motion.div>
          </div>
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 mb-6">{t("matlab.limitations")}</p>
                <ul className="space-y-3">
                  {t.raw("matlab.limitationItems").map((item: string, index: number) => (
          ...
          >
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-400 leading-relaxed mb-6">{t("matlab.text3")}</p>
          ...
          >
            <p className="text-cyan-400 font-medium">{t("matlab.recommendation")}</p>
          </motion.div>
        </div>
      </section>
