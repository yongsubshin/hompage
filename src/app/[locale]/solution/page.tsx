...
export default function SolutionPage() {
  ...
  const solutions = [
    {
      id: "cloudnative",
      name: nav("solutionCloud"),
      description: t("cards.cloudnative"),
      icon: Cloud,
      color: "cyan",
    ...
    {
      id: "digital",
      name: nav("solutionDigital"),
      description: t("cards.digital"),
      icon: Cpu,
      color: "blue",
    ...
    {
      id: "matlab",
      name: nav("solutionMatlab"),
      description: t("cards.matlab"),
      icon: BarChart3,
      color: "blue",
    ...
    {
      id: "aiagent",
      name: nav("solutionAgent"),
      description: t("cards.aiagent"),
      icon: Bot,
      color: "cyan",
        ...
        <div className="container-custom relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              ...
              <span className="gradient-text">{t("mainTitle").split(" ").slice(-1)}</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
