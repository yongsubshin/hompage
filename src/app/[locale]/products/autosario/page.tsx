...
export default function AutosarioPage() {
  const content = useTranslations("autosario");
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center mb-32">
            ...
            >
              ...
              <div className="space-y-4">
                {content.raw("supportItems").map((item: string, index: number) => (
                  <motion.div
                    key={index}
            ...
            >
              ...
              <div className="space-y-4">
                {content.raw("benefits").map((benefit: string, index: number) => (
                  <motion.div
                    key={index}
                    initial={{ opacity: 0, x: 20 }}
                    whileInView={{ opacity: 1, x: 0 }}
        ...
        <div className="container-custom relative z-10">
          ...
          >
            <div className="grid sm:grid-cols-3 gap-4">
              {content.raw("versions").map((version: string, index: number) => (
                <motion.div
                  key={index}
