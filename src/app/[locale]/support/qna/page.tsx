      ...
      <section className="relative min-h-[40vh] flex items-center justify-center py-20">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent-cyan/10 border border-accent-cyan/20 mb-6">
            ...
            <span className="text-sm text-accent-cyan font-medium">{common("support")}</span>
          </div>
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white">{t("qna.title")}</h1>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-center mb-12">
              <h2 className="text-2xl font-bold mb-4 text-white">{t("qna.formTitle")}</h2>
              <p className="text-text-secondary">
                {t("qna.formDescription")}
              </p>
            </div>
            ...
            {status === "success" && (
              ...
              >
                ...
                <p className="text-emerald-300">{t("qna.submitSuccess")}</p>
              </motion.div>
            )}
            ...
            {status === "error" && (
              ...
              >
                ...
                <p className="text-red-300">
                  {t("qna.submitError") || errorMessage}
                </p>
              </motion.div>
            )}
            ...
            <form onSubmit={handleSubmit} className="bg-surface rounded-2xl border border-border p-8">
              <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    disabled={isSending}
                    className="w-full px-4 py-3 bg-surface border border-border rounded-lg focus:ring-2 focus:ring-accent-cyan focus:border-transparent outline-none transition-all text-white placeholder-tertiary disabled:opacity-50"
                    placeholder={t("qna.companyPlaceholder")}
                  />
                </div>
              ...
              <div className="mb-6">
                ...
                >
                  <option value="product">{t("qna.inquiryTypes.product")}</option>
                  <option value="service">{t("qna.inquiryTypes.service")}</option>
                  <option value="education">{t("qna.inquiryTypes.education")}</option>
                  <option value="partnership">{t("qna.inquiryTypes.partnership")}</option>
                </select>
              </div>
              ...
              <div className="mb-8">
                ...
                <textarea
                  ...
                  placeholder={t("qna.messagePlaceholder")}
                />
              </div>
