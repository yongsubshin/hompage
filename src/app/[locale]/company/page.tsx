          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-accent-cyan/10 border border-accent-cyan/20 mb-6">
                ...
                <span className="text-sm text-accent-cyan font-medium">{t("badge")}</span>
              </div>
              ...
              <p className="text-xl lg:text-2xl text-text-secondary mb-4 leading-relaxed text-balance">
                {t("subtitle1")}
                <br />
                <span className="text-accent-cyan">{t("subtitle2")}</span>
              </p>
              ...
              <div className="relative w-full aspect-square max-w-lg mx-auto">
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-white">{t("visionMission")}</span>
                  </div>
                  <p className="text-xs text-text-tertiary">{t("visionMissionDesc")}</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-white">{t("visionInnovation")}</span>
                  </div>
                  <p className="text-xs text-text-tertiary">{t("visionInnovationDesc")}</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-white">{t("visionCollaboration")}</span>
                  </div>
                  <p className="text-xs text-text-tertiary">{t("visionCollaborationDesc")}</p>
                </motion.div>
                ...
                >
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="font-semibold text-white">{t("visionGrowth")}</span>
                  </div>
                  <p className="text-xs text-text-tertiary">{t("visionGrowthDesc")}</p>
                </motion.div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface border border-border mb-6">
              ...
              <span className="text-sm text-text-secondary">{t("companyVideo")}</span>
            </div>
          ...
          >
            <div className="bg-surface/80 backdrop-blur rounded-2xl border border-border overflow-hidden shadow-2xl">
              ...
              <div className="flex items-center gap-2 px-4 py-3 bg-surface border-b border-border">
                ...
                <span className="text-xs text-text-tertiary ml-2">{t("videoTitle")}</span>
              </div>
              {/* Video */}
            ...
            >
              ...
              <div className="flex items-center gap-4">
                <div className="bg-surface border border-border rounded-xl p-4 text-center">
                  <p className="text-3xl font-bold text-accent-cyan">{t("statYears")}</p>
                  <p className="text-xs text-text-tertiary">{t("statYearsLabel")}</p>
                </div>
                <div className="bg-surface border border-border rounded-xl p-4 text-center">
                  <p className="text-3xl font-bold text-accent-blue">{t("statClients")}</p>
                  <p className="text-xs text-text-tertiary">{t("statClientsLabel")}</p>
                </div>
                <div className="bg-surface border border-border rounded-xl p-4 text-center">
                  <p className="text-3xl font-bold text-accent-purple">{t("statProjects")}</p>
                  <p className="text-xs text-text-tertiary">{t("statProjectsLabel")}</p>
                </div>
              </div>
            </motion.div>
          ...
          <div className="bg-surface rounded-3xl border border-border p-8 md:p-12">
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-xl font-semibold text-white">{t("customers")}</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-xl font-semibold text-white">{t("partners")}</h3>
              </div>
            ...
            >
              <div className="flex items-center gap-3 mb-8">
                ...
                <h3 className="text-xl font-semibold text-white">{t("investors")}</h3>
              </div>
              ...
              <p className="text-sm text-text-tertiary mt-6">{t("sortNote")}</p>
            </motion.div>
          </div>
        </div>
      </section>
