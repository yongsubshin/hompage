...
export default function NoticePage() {
  ...
  const getCategoryLabel = (category: string) => {
    switch (category) {
      case "product":
        return t("notice.categories.product");
      case "update":
        return t("notice.categories.update");
      case "event":
        return t("notice.categories.event");
      case "recruitment":
        return t("notice.categories.recruitment");
      default:
        return category;
    }
  };
        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-accent-cyan font-medium">{t("notice.badge")}</span>
            </motion.div>
